...
public class LabDAOImpl implements labDAO {
    ...
    public void save(Lab lab) throws SQLException {
        try{
            PreparedStatement preparedStatement = ConnectionUtil.getConnection().prepareStatement(INSERT_LAB);
    ...
    public boolean update(Lab lab) throws SQLException {
        ...
        try{
            PreparedStatement preparedStatement = ConnectionUtil.getConnection().prepareStatement(UPDATE_LAB);
            preparedStatement.setInt(1,lab.getLabId());
            preparedStatement.setInt(2,lab.getNumOfEmployees());
            preparedStatement.setString(3,lab.getLocation());
            preparedStatement.setInt(4,lab.getCapacity());
    ...
    public Lab get(Integer id) {
        Lab lab = null;
        try {
            PreparedStatement preparedStatement = ConnectionUtil.getConnection().prepareStatement(SELECT_LAB_BY_ID);
    ...
    public boolean delete(Integer id) {
        ...
        try {
            PreparedStatement preparedStatement= ConnectionUtil.getConnection().prepareStatement(DELETE_LAB);
            preparedStatement.setInt(1,id);
    ...
    public List<Lab> list() {
        ...
        try {
            PreparedStatement preparedStatement =  ConnectionUtil.getConnection().prepareStatement(SELECT_ALL_LABS);
            System.out.println(preparedStatement);
            ResultSet rs = preparedStatement.executeQuery();
            while(rs.next()){
                int labId = rs.getInt("id");
